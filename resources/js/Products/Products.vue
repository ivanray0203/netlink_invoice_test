      ...
      <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          ...
          >
            ...
            <td class="py-4 px-6">
              <a-button type="primary" ghost @click="showUpdateModal(product)"
                >Edit</a-button
              >
              <a-button
    ...
    <Modal v-model:visible="visible" title="Product" @ok="handleOk">
      ...
      <form class="px-8 pt-6 pb-8 mb-4">
        ...
        <div class="mb-4">
          ...
          <p v-if="errors.category_id" class="text-red-500 text-xs">
        ...
        <div class="mb-4">
          ...
          />
          <p v-if="errors.quantity" class="text-red-500 text-xs">
            {{ errors.quantity[0] }}
          </p>
        </div>
      </form>
...
const handleOk = () => {
  ...
  if (isEdit.value) {
    axios
      .put(`api/products/${product_id.value}`, form)
      .then((response) => {
        notification.success({
